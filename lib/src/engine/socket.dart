...
class Socket extends EventEmitter {
  ...
  late bool upgrade;
  late String path;
  late bool forceJSONP;
  late bool jsonp;
  late bool forceBase64;
  late bool enablesXDR;
  late String timestampParam;
  late var timestampRequests;
  late List<String> transports;
  late Map transportOptions;
  late String readyState;
  late List writeBuffer;
  late int prevBufferLen;
  late int policyPort;
  late bool rememberUpgrade;
  late var binaryType;
  late bool onlyBinaryUpgrades;
  late Map perMessageDeflate;
  late String? id;
  late List upgrades;
  late int pingInterval;
  late int pingTimeout;
  late Timer pingIntervalTimer;
  late Timer pingTimeoutTimer;
...
//  'localAddress: options.localAddress || this.localAddress,
   ...
   * @api private
   */
  sendPacket({type, data, options, required EventHandler callback}) {
