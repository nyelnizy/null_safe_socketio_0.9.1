...
class Manager extends EventEmitter {
  // Namespaces
  late Map<String, Socket> nsps;
  late List subs;
  late Map options;

  late bool _reconnection;
  late num _reconnectionAttempts;
  late num _reconnectionDelay;
  late num _randomizationFactor;
  late num _reconnectionDelayMax;
  late int _timeout;
  late _Backoff backoff;
  late String readyState;
  late String uri;
  late List connecting;
  num? lastPing;
  late bool encoding;
  late List packetBuffer;
  late bool reconnecting = false;

  late Engine.Socket engine;
  late Encoder encoder;
  late Decoder decoder;
  late bool autoConnect;
  late bool skipReconnect;
  ...
  reconnect() {
    ...
    if (this.backoff.attempts >= this._reconnectionAttempts) {
      ...
      var timer = new Timer(new Duration(milliseconds: delay.toInt()), () {
